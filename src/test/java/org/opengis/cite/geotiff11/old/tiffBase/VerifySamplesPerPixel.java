...
import org.opengis.cite.geotiff11.old.tiffBase.SamplesPerPixel;
import org.testng.ISuite;
import org.testng.ITestContext;
import org.xml.sax.SAXException;

public class VerifySamplesPerPixel {
	private static final String SUBJ = "testSubject";
	private static ITestContext testContext;
	private static ISuite suite;
	SamplesPerPixel iut;

	public VerifySamplesPerPixel() {
	...
	public void supplyNullTestSubject() throws SAXException, IOException {
		SamplesPerPixel iut = new SamplesPerPixel();
		iut.verifySamplesPerPixelExists();
	}

	@Test
	public void verifySamplesPerPixelExists() throws SAXException, IOException {
		this.iut.obtainTestSubject(testContext);
		this.iut.verifySamplesPerPixelExists();
	}

	@Test
	public void verifySamplesPerPixelValue() {
		this.iut.obtainTestSubject(testContext);
		this.iut.verifySamplesPerPixelValue();
	}
}
