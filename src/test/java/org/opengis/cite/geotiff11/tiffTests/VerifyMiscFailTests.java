...
public class VerifyMiscFailTests {
	...
	/*
	 * If the EllipsoidGeoKey value is 32767 (User-Defined) then the GTCitationGeoKey and
	 * the EllipsoidSemiMajorAxisGeoKey SHALL be populated together with the one of either
	 * the EllipsoidSemiMinorAxisGeoKey or the EllipsoidInvFlatteningGeoKey [test case for
	 * both of them there (this one should fail)
	 *
	 * @throws Exception
	 */
	@Test(expected = AssertionError.class)
	...
	/*
	 * NULL (ASCII code = 0) characters SHALL not be present in the string content written
