package org.opengis.cite.geotiff11.level1;
...
import org.opengis.cite.geotiff11.ErrorMessage;
import org.opengis.cite.geotiff11.ErrorMessageKeys;
...
public class Capability1Tests extends CommonFixture {
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/geotiff11/rnc/atom.rnc");
