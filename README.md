## Test suite: ets-geotiff10

### Scope

Describe scope of the test suite.

Visit the [project documentation website](http://opengeospatial.github.io/ets-geotiff10/) 
...
Set the main class to run: `org.opengis.cite.geotiff10.TestNGController`
...
`java -jar ets-geotiff10-0.1-SNAPSHOT-aio.jar [-o|--outputDir $TMPDIR] [test-run-props.xml]`
